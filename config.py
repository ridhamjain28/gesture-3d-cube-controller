...
# ============================================================================
# CAMERA SETTINGS - ULTRA-OPTIMIZED FOR 7GB RAM (SMOOTHEST FPS)
# ============================================================================
CAMERA_INDEX = 0  # Default camera (0=built-in, 1=external USB, etc.)
FRAME_WIDTH = 480  # Camera resolution width - ULTRA OPTIMIZED for smooth 30 FPS
FRAME_HEIGHT = 360  # Camera resolution height - ULTRA OPTIMIZED for smooth 30 FPS
FPS_TARGET = 30  # Target frames per second
SKIP_FRAMES = 1  # Process every Nth frame (1=all, 2=every other) for smoother FPS

# ============================================================================
# MEDIAPIPE HAND TRACKING SETTINGS - OPTIMIZED FOR PERFORMANCE
# ============================================================================
# Detection confidence: Higher = fewer false positives, lower = better detection
DETECTION_CONFIDENCE = 0.6  # Range: 0.0-1.0 (recommended: 0.5-0.8) - REDUCED FOR SPEED
...
MODEL_COMPLEXITY = 0  # 0 or 1 (use 0 for low-end hardware) - SET TO LITE MODE
...
SMOOTHING_WINDOW = 3  # Number of frames to average (3-10) - REDUCED for responsiveness
...
DEBOUNCE_FRAMES = 1  # Recommended: 2-4 - SET TO 1 for instant response
...
# ============================================================================
# DEBUGGING & LOGGING - OPTIMIZED (LESS OVERHEAD)
# ============================================================================
DEBUG_MODE = False  # Print detailed logs - DISABLED FOR PERFORMANCE
LOG_GESTURES = False  # Log detected gestures - DISABLED FOR PERFORMANCE
